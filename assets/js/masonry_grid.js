...
(function ($) {
  ...
  $.fn.AddonsGridLayout = function () {
    ...
    function calculateMasonrySize(isotopeOptions) {
      ...
      var totalGutterPerRow = (gridColumns - 1) * gridGutter;

      var columnWidth = (gridWidth - totalGutterPerRow) / gridColumns;
    ...
    return this.each(function () {
      ...
      $(".portfolio-filter-buttons li a").on("click", function () {
        $(".portfolio-filter-buttons").find(".current").removeClass("current");
